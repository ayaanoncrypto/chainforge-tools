    ...
    <main className="relative mx-auto hidden max-w-[1680px] px-3 py-3 lg:block lg:px-5 lg:py-5">
      <div className="grid min-h-[calc(100vh-2.5rem)] grid-cols-1 overflow-hidden border border-slate-700/80 bg-[#151b31]/90 shadow-[0_35px_120px_rgba(0,0,0,0.38)] lg:grid-cols-[220px_minmax(0,1fr)_370px]">
        ...
        <section className="min-w-0 bg-[#171d34]/75">
          ...
          <footer className="border-t border-slate-700/80 px-5 py-5 sm:px-8"><div className="grid gap-4 sm:grid-cols-[1fr_auto] sm:items-center"><p className="font-mono text-[10px] leading-5 text-slate-500">ChainForge is a local-first tool directory for calculation, formatting, and workflow prep. Review sensitive transactions before you sign.</p><div className="flex flex-wrap items-center gap-4 font-mono text-[10px] uppercase tracking-[0.12em] text-slate-500"><span>Private by default</span><span>•</span><span>Built for work</span><a href="https://ayaan.lol" target="_blank" rel="noreferrer" className="normal-case tracking-normal text-slate-300 transition hover:text-[#b8ff3d]">Made with <span aria-label="love" className="text-[#b8ff3d]">❤️</span> by ayaan.lol</a></div></div></footer>
        </section>
